...
export async function getCurrentUser() {
  try {
    ...
    // NOTE: Profile role column was removed from DB. 
    // Roles are now handled via RBAC service / uasurios-roles table.
    // This function determines 'role' property which is now deprecated.
